...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'social_liked', (
            ...
            ('point', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
        ))
        ...
        # Adding unique constraint on 'Favorited', fields ['user', 'path']
        db.create_unique(u'social_favorited', ['user_id', 'path'])


    def backwards(self, orm):
        # Removing unique constraint on 'Favorited', fields ['user', 'path']
        db.delete_unique(u'social_favorited', ['user_id', 'path'])
    ...
    models = {
        ...
        u'social.favorited': {
            'Meta': {'unique_together': "(('user', 'path'),)", 'object_name': 'Favorited'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'social.liked': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'path': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'point': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
