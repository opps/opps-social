...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Liked'
        db.create_table(u'social_liked', (
        ...
        db.send_create_signal(u'social', ['Liked'])

        # Adding model 'Favorited'
        db.create_table(u'social_favorited', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_insert', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ...
        db.send_create_signal(u'social', ['Favorited'])

        # Adding unique constraint on 'Favorited', fields ['site', 'user', 'container']
        db.create_unique(u'social_favorited', ['site_id', 'user_id', 'container_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Favorited', fields ['site', 'user', 'container']
        db.delete_unique(u'social_favorited', ['site_id', 'user_id', 'container_id'])

        # Deleting model 'Liked'
        db.delete_table(u'social_liked')

        # Deleting model 'Favorited'
        db.delete_table(u'social_favorited')
    ...
    models = {
        ...
        u'social.favorited': {
            'Meta': {'unique_together': "(('site', 'user', 'container'),)", 'object_name': 'Favorited'},
